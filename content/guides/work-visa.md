...
Usually, you can't work while you wait for your work visa.[^35] You might wait [a few months](/tools/residence-permit-feedback) with no income. It's cheaper and safer if you [apply in your home country](#how-to-apply-in-your-country), then come to Germany when you have permission to work.
...
The *Ausländerbehörde* will process your application. If you [send your documents online](/guides/berlin-auslanderbehorde-appointment#send-your-documents-and-wait), it takes [a few weeks](/tools/residence-permit-feedback) to get a response. Then they will invite you for an appointment.
...
If they approve your work visa, they must print the plastic card. You will get a second appointment to collect your work visa in [in around 8 weeks](/tools/residence-permit-feedback).{{ fail_on('2025-01-15') }} You might get a temporary document that confirms that your work visa was approved. It allows you to start working, but it's not a valid travel document. It does not allow you to leave and re-enter Germany.
...
2. **Go to your appointment**  
    During the appointment, they take your fingerprints for your work visa. It takes around 15 minutes. You get a second appointment [around 8 weeks later](/tools/residence-permit-feedback) to pick up your work visa.{{ fail_on('2025-01-15') }}
