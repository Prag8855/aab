...
Related_guides: guides/how-to-get-a-german-freelance-visa.md, guides/start-a-business-in-germany.md, guides/berlin-auslanderbehorde-same-day-appointment.md, guides/become-a-freelancer-in-germany.md
---
...
The template below is the official example found [on Berlin.de](https://service.berlin.de/dienstleistung/305249/). The Berlin *[[Ausländerbehörde]]* prefers when you use this template, but you can also make your own *Finanzierungsplan*.
