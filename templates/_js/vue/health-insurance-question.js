		...
		<div ref="collapsible" class="health-insurance-question">
			<template v-if="stage === 'contactInfo'">
				<div class="form-recipient">
					<div>
						<p>Seamus will help you <strong>{{ whatSeamusWillDo(false) }}</strong>. I trust him because he is honest and knowledgeable.</p>
				...
				<div class="buttons bar" v-if="contactMethod || $slots['form-buttons']">
					...
					<button v-if="contactMethod === 'email'" class="button primary no-print" @click="submitForm" :disabled="isLoading" :class="{loading: isLoading}" v-html="submitButtonText"></button>
